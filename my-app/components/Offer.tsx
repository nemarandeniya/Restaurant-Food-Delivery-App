    ...
    return (
        <div className='flex flex-col lg:flex-row h-[calc(100vh-6rem)] '>
            <div className="h-1/2 lg:h-full lg:w-1/2 flex items-center justify-center flex-col gap-8 bg-black">
                ...
                <CountDown />
                <button className=' p-3 rounded-sm bg-cyan-950 shadow-xl hover:shadow-4xl text-amber-50 cursor-pointer hover:scale-115 transition-transform duration-300'>order now</button>
            </div>
